...
### PQMC (QMC + SP)
```{r pmc-mixture-qmc-sp, warning = F, message = F, fig.height = 6, fig.width = 9}
layout(matrix(c(1:6), nrow = 2, byrow = T))
...
### PQMC (SP + SP)
```{r pmc-mixture-sp-sp, warning = F, message = F, fig.height = 6, fig.width = 9}
layout(matrix(c(1:6), nrow = 2, byrow = T))
pmc.sp <- pmc(ini, logmixture, J, steps, sigma, 
...
### PQMC (MSP + SP)
```{r pmc-mixture-msp-sp, warning = F, message = F, fig.height = 6, fig.width = 9}
layout(matrix(c(1:6), nrow = 2, byrow = T))
pmc.sp <- pmc(ini, logmixture, J, steps, sigma, 
...
### PQMC (QMC + SP)
```{r pmc-banana-qmc-sp, warning = F, message = F, fig.height = 6, fig.width = 9}
layout(matrix(c(1:6), nrow = 2, byrow = T))
...
### PQMC (SP + SP)
```{r pmc-banana-sp-sp, warning = F, message = F, fig.height = 6, fig.width = 9}
layout(matrix(c(1:6), nrow = 2, byrow = T))
pmc.sp <- pmc(ini, logbanana, J, steps, sigma, 
              sample = "sp", resample = "sp",
              sigma.adapt = adaptation, visualization = T)
...
### PQMC (MSP + SP)
```{r pmc-banana-msp-sp, warning = F, message = F, fig.height = 6, fig.width = 9}
layout(matrix(c(1:6), nrow = 2, byrow = T))
pmc.sp <- pmc(ini, logbanana, J, steps, sigma, 
              sample = "msp", resample = "sp",
              sigma.adapt = adaptation, visualization = T)
