...
Consider resmaple n = 100 points from 10000 Sobol points over the unit square as importance samples for the mixture of normals using multinomial, residual, Hilbert curve sorted systematic, Hilbert curve sorted stratified, and importance support points (ISP).
...
Let us now run PMC and PQMC on the mixture of five normals with K = 50, J = 20, and T = 8. The initial centers are the 50 Sobol points over the unit square. Adaptation for covariance is applied for PQMC only. Here follows the parameter setting.

```{r mixture-setting, warning = F, message = F}
...
### PMC (Multinomial)
```{r pmc-mixture-mn, warning = F, message = F, fig.height = 9, fig.width = 9}
# setting
sampling <- "random"
...
### PMC (Residual)
```{r pmc-mixture-rs, warning = F, message = F, fig.height = 9, fig.width = 9}
# setting
sampling <- "random"
resampling <- "residual"
sigma.adapt <- FALSE
...
```{r pqmc-mixture-ss, warning = F, message = F, fig.height = 9, fig.width = 9}
# setting
sampling <- "qmc"
...
```{r pqmc-mixture-st, warning = F, message = F, fig.height = 9, fig.width = 9}
# setting
sampling <- "qmc"
...
### PQMC (ISP + Lookback)
```{r pqmc-mixture-isp, warning = F, message = F, fig.height = 9, fig.width = 9}
# setting
sampling <- "qmc"
resampling <- "sp"
sigma.adapt <- TRUE # lookback covariance adaptation
...
Let us now run PQMC on the banana shaped distribution with K = 50, J = 20, and T = 8. The initial centers are the 50 Sobol points over the unit square. Adaptation for covariance is applied. Here follows the parameter setting.

```{r banana-setting, warning = F, message = F}
...
### PQMC (ISP + Lookback)
```{r pqmc-banana-isp, warning = F, message = F, fig.height = 9, fig.width = 9}
# setting
sampling <- "qmc"
resampling <- "sp"
sigma.adapt <- TRUE # lookback covariance adaptation
